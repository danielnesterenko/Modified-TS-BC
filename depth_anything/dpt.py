...
from depth_anything.huggingface_hub import PyTorchModelHubMixin, hf_hub_download
...
class DPT_DINOv2(nn.Module):
    ...
    def forward(self, x):
        ...
        features = self.pretrained.get_intermediate_layers(x, 24, return_class_token=True)
